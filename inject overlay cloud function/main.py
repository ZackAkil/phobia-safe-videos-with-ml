...
OUTPUT_BUCKET = 'gs://YOUR_FINAL_BUCKET_OUTPUT/'
# parent location for Transcoder API e.g 'projects/1234567890/locations/europe-west1'
parent_location ='projects/YOUR PROJECT ID/locations/YOUR REGION'
...
def create_safe_video(event, context):
    ...
    overlay_segments = []
    for seg in segments:
        overlay_segments += create_fade_overlay_segment(*seg)
